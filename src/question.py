esg_question = [
    "近二年發生環保違規情節重大或導致停工/停業者",
    "近二年發生違反人權(強制勞動、童工問題等)導致停工/停業者",
    "近二年發生勞工權益糾紛情節重大或導致停工/停業者",
    "近二年發生公司治理問題情節重大或導致停工/停業者",
    "近二年發生洗錢或資助資恐活動情節重大或導致停工/停業者",
    "近二年發生工安事件情節重大或導致停工/停業者",
    "企業進行色情、野生動物捕殺或棲地破壞、受國際禁限的化學品/藥品/農藥/除草劑或放射性物質之作為",
    "於公開管道揭露E&S相關資訊(如：企業官網、年報、企業社會責任報告書、永續報告書)",
    "近一年曾獲得外部永續相關獎項",
    "設有E&S風險專責單位。(如:風險管理委員會、企業社會責任委員會)",
    "辨識利害關係人關注之E&S議題",
    "響應國內外E&S倡議",
